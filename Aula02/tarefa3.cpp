...
double inner_prod(double *a, double *b, int n) {//falta
    double sum = 0;
    for (int i = 0; i < n; i++) {
        sum += a[i] * b[i];
    }
...
void gauss(double *a, double *b, int n) { //falta
...
int main (int argc, char *argv[]) {
  int size = 1000000000;//tamanho do array "a"
  ...
  int x = inner_prod(vetor,vetor2, size);
  ...
  std::chrono::duration<double> elapsed_seconds3 = elapsed_seconds = std::chrono::duration_cast<std::chrono::duration<double> >(end3-start3);
  ...
  std::cout << "\n finished computation (sqrt_element) at " << std::ctime(&end_time3)
            << "elapsed time 3: " << elapsed_seconds.count() << "s\n";

  auto start4 = std::chrono::high_resolution_clock::now();
  exp_element(vetor, size);
  auto end4 = std::chrono::high_resolution_clock::now();
  std::chrono::duration<double> elapsed_seconds4 = elapsed_seconds = std::chrono::duration_cast<std::chrono::duration<double> >(end4-start4);
  ...
  std::cout << "\n finished computation (exp_element) at " << std::ctime(&end_time4)
            << "elapsed time 4: " << elapsed_seconds.count() << "s\n";

  auto start5 = std::chrono::high_resolution_clock::now();
  log_element(vetor, size);
  auto end5 = std::chrono::high_resolution_clock::now();
  std::chrono::duration<double> elapsed_seconds5 = elapsed_seconds = std::chrono::duration_cast<std::chrono::duration<double> >(end5-start5);
  ...
  std::cout << "\n finished computation (log_element) at " << std::ctime(&end_time5)
            << "elapsed time 5: " << elapsed_seconds.count() << "s\n";

  auto start6 = std::chrono::high_resolution_clock::now();
  gauss(vetor,vetor2, size);
  auto end6 = std::chrono::high_resolution_clock::now();
  std::chrono::duration<double> elapsed_seconds6 = elapsed_seconds = std::chrono::duration_cast<std::chrono::duration<double> >(end6-start6);
  std::time_t end_time6 = std::chrono::high_resolution_clock::to_time_t(end6);
  std::cout << "\n finished computation (gauss) at " << std::ctime(&end_time6)
            << "elapsed time 6: " << elapsed_seconds.count() << "s\n \n";
